  ...
  useEffect(() => {
    const fetchData = async () => {
        try {
          ...
          const filteredData = [...trendingMoviesResponse.data.results, ...trendingTVResponse.data.results, ...topTVResponse.data.results, ...topMoviesResponse.data.results].filter((item) => {
